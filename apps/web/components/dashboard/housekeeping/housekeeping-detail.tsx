...
export function HousekeepingDetail({
  task,
  teamMemberOptions,
  role,
}: HousekeepingDetailProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {canStart ? (
              <Button
                ...
                loading={isPending}
                onClick={() => runAction(startHousekeepingTaskAction(task.id))}
              >
                Start task
              </Button>
            ) : null}
        ...
        <div className="flex flex-col gap-6 lg:col-span-2">
          <SectionCard id="task-info" title="Task information">
            <dl className="divide-y divide-hairline">
              ...
              <Row label="Linked reservation">
                {task.reservationId ?? "None"}
              </Row>
            </dl>
          </SectionCard>
      ...
      <HousekeepingFormDrawer
        ...
        onSubmit={(formData) =>
          submitDrawerAction(
            updateHousekeepingTaskAction(task.id, formData),
            () => setEditing(false),
          )
        }
      />
      ...
      <HousekeepingAssignDrawer
        ...
        onSubmit={(formData) =>
          submitDrawerAction(
            assignHousekeepingTaskAction(task.id, formData),
            () => setAssigning(false),
          )
        }
      />
      ...
      <HousekeepingCompleteDrawer
        ...
        onSubmit={(formData) =>
          submitDrawerAction(
            completeHousekeepingTaskAction(task.id, formData),
            () => setCompleting(false),
          )
        }
      />
